...
const requiredKeys = [
  ...
  "replay.mode.backoff",
  "replay.mode.burst",
  "replay.gapOrderError",
  "replay.fields.mode",
  "replay.fields.intervalSecs",
  "replay.fields.backoffStartSecs",
  "replay.fields.backoffMultPercent",
  "replay.fields.backoffCapSecs",
  "replay.fields.burstAttemptsPerRound",
  "replay.fields.burstRoundGapMinSecs",
  "replay.fields.burstRoundGapMaxSecs",
  ...
  "replay.hints.backoffStartSecsBurst",
  "replay.hints.backoffMultPercent",
  "replay.hints.backoffCapSecs",
  "replay.hints.burstAttemptsPerRound",
  "replay.hints.burstRoundGapMinSecs",
  "replay.hints.burstRoundGapMaxSecs",
  "replay.hints.burst",
  "replay.hints.burstGap",
